...
("what colour is it?") with an out-of-scope catch-all. Specialists like
navigate/swiggy/status hand back to supervisor by design, so they are
intentionally NOT sticky — the turn after them starts at chat.
